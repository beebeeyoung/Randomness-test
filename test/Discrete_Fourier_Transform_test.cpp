#ifndef		DISCRETE_FOURIER_TRANSFORM_TEST_CPP
#define		DISCRETE_FOURIER_TRANSFORM_TEST_CPP
...
namespace test{
    ...
    void DiscreteFourierTransformTest::run(std::vector<bool> &bits){
        P = Discrete_Fourier_Transform_test(bits);
    }

    const char* DiscreteFourierTransformTest::testName(int lang){
